...
export const metadata: Metadata = {
  title: "מבצעים | TikTime",
  description: "שעוני יוקרה במחירים מיוחדים – מבצעים למוגבל בזמן",
};
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <nav className="flex items-center gap-2 text-sm text-gray-500">
            <Link href="/" className="hover:text-[#c9a96e] transition-colors">בית</Link>
            <span>/</span>
            <span className="text-[#222021] font-semibold">מבצעים</span>
          </nav>
        </div>
      </div>
        ...
        {products.length === 0 ? (
          <div className="text-center py-20">
            ...
            <p className="text-gray-500 mb-6">
              חזרו בקרוב – מבצעים חדשים מתעדכנים כל הזמן
            </p>
            <Link
              href="/category/gevarim"
              className="inline-block bg-[#c9a96e] hover:bg-[#b8933a] text-white font-bold px-7 py-3 rounded transition-colors"
            >
              לכל הקולקציה
            </Link>
          </div>
